...
{
      double vertices[3][4];             //matrix contains vertices of the triangle
      ...
      void reflection();
      void scaling(double a,double d,double e);
      void shearing(double b,double c,double,double,double,double);
...
void transformations::rotation(double angle,double m,double n)
{
     ...
     t_matrix[0][0]=1;                     //Matrix for scaling the triangle
     t_matrix[0][1]=0;
     t_matrix[0][2]=0;
     t_matrix[0][3]=0;
     t_matrix[1][0]=0;
     t_matrix[1][1]=cos(angle);
     t_matrix[1][2]=sin(angle);
     t_matrix[1][3]=0;
     t_matrix[2][0]=0;
     t_matrix[2][1]=(sin(angle)*(-1));
...
void transformations::reflection()
{
     ...
     // delay(20);
     // getch();
     cout<<"REFLECTION ALONG XY PLANE\n";
     t_matrix[0][0]=1;                     //Matrix for scaling the triangle
     t_matrix[0][1]=0;
     t_matrix[0][2]=0;
     t_matrix[0][3]=0;
...
void transformations::scaling(double a,double d,double e)
{
     copyback();
     // cleardevice();
...
void transformations::shearing(double b,double c,double d,double f,double g,double i)
{
     copyback();
     // cleardevice();
...
//    int gd=DETECT,gm,choice;
    transformations t1;
    char ch1,ch2;
    double angle,m,n,slope,intercept,a,b,c,d,e,f,g,i;
     int choice;
    do
    {
...
//	      initgraph(&gd,&gm,"C:\\Turboc3\\BGI");
		  ...
		  case 4:cout<<"\n ----SHEARING----";
			 cout<<"\n Enter the factos(6) of shearing: ";
			//  cout<<"\n Along the X-axis: ";
			 cin>>b;
			//  cout<<"\n Along the Y-axis: ";
			 cin>>c>>d>>f>>g>>i;

			 t1.shearing(b,c,d,f,g,i);
			 break;
